        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/ZangeressenController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="geboorteland" type="text" class="form-control <?= isset($data['errors']['geboorteland']) ? 'is-invalid' : ''; ?>" id="geboorteland" value="<?= $_POST['geboorteland'] ?? $data['zangeres']->Geboorteland ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="vermogen" type="number" min="0" max="99999999" step="0.01" class="form-control <?= isset($data['errors']['vermogen']) ? 'is-invalid' : ''; ?>" id="vermogen" value="<?= $_POST['vermogen'] ?? $data['zangeres']->Vermogen ?>">
